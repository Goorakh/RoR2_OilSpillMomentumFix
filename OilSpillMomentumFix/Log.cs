...
namespace OilSpillMomentumFix
{
    internal static class Log
    {
        ...
        static Log()
        {
            ...
            {
                const string MOD_NAME = nameof(OilSpillMomentumFix) + @"\";
                ...
                {
                    UnityEngine.Debug.LogError($"[{OilSpillMomentumFixPlugin.PluginName}] Logger failed to determine caller path prefix length");
                    return 0;
                }
            }
        }
